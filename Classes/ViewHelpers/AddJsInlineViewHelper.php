 ...
 */
class Tx_SocialSharingPrivacy_ViewHelpers_AddJsInlineViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	{
		if ($code) {
			Tx_SocialSharingPrivacy_Utility_Div::addJsInline(
				$code,
				$name,
				$moveToFooter
			);
