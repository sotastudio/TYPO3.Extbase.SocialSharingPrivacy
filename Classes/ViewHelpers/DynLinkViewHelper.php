 ...
 */
class Tx_SocialSharingPrivacy_ViewHelpers_DynLinkViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper
{
	...
	protected function processLinkParams($link)
	{
		...
		$paramDataArr = Tx_SocialSharingPrivacy_Utility_Div::combineArray($this->paramLabels, $paramDataArr, false);
